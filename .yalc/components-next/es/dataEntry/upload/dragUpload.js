...
import { useReactive } from 'ahooks'; //@ts-ignore
...
var DragUpload = function DragUpload(props) {
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Upload, _objectSpread({
    accept: 'image/*',
    name: 'file',
    type: 'drag',
    onStart: function () {
    ...
    className: clx('text-gray-400 text-center relative h-36 rounded-lg border-dashed border-2 border-gray-200 hover:border-blue-200 bg-white flex justify-center items-center hover:cursor-pointer')
  }, previewImg && /*#__PURE__*/React.createElement("div", {
    className: "mb-4 h-32"
  }, /*#__PURE__*/React.createElement("img", {
    src: previewImg,
    className: "h-full object-cover p-2"
  })), /*#__PURE__*/React.createElement("div", {
    className: (clx('flex flex-col'), previewImg && 'absolute bottom-0 py-[2px] bg-gradient-to-r from-green-400 to-blue-500 w-full rounded-md text-white text-xs opacity-60')
  }, /*#__PURE__*/React.createElement("span", null, "Attach you files here"), /*#__PURE__*/React.createElement("span", null, " or "), /*#__PURE__*/React.createElement("span", {
    className: clx('text-blue-400', previewImg && 'text-white')
  }, "Browse files")))), state.uploadPt > 0 && /*#__PURE__*/React.createElement(Line, {
